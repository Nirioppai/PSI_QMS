...
<div class="container">
  ...
  <div class="row justify-content-center align-items-center">
    <div class="col-sm-8">
      ...
      <div class="alert  alert-warning alert-dismissible fade show" role="alert">
            <span class="badge badge-pill badge-warning text-white">Warning</span> &nbsp;&nbsp;&nbsp;You have no Station Administrators. Contact a Super Admin to make one now.
  ...
  <div class="row justify-content-center align-items-center toast-alert" id="myDiv">
    <div class="col-sm-8">
    <a href="/queueadmin/accounts/new">
