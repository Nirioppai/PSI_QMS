          ...
          <div class="container">
            <div class="row">
              <div class="col-sm text-left">
                <a href="/superadmin/queues/new" data-html="true" data-toggle="tooltip" data-placement="top" title="Create your queue <b>from the start</b>." class="btn btn-primary"><i class="fas fa-undo-alt"></i> Reset Queue</a>
              </div>
              <div class="col-sm text-right">
                {!! Form::open(['url' => '/superadmin/queues/new/modify/save']) !!}
    ...
    <div class="card bg-secondary shadow-lg border-0">
      ...
      <div class="card-body px-md-5 py-lg-4">
        <div class="container">
              ...
              <div class="table-responsive">
                <table class="table align-items-center table-flush">
                  ...
                  <tr>
                    ...
                    <td>{{$queue_designer1->number_of_windows}}</td>
                    <td>{{$queue_designer1->station_admin}}</td>
                    <td><a data-html="true" data-toggle="tooltip" data-placement="top" title="Edit Station Details." href="/superadmin/queues/new/modify/{{$queue_designer1->id}}/edit" class="btn btn-primary"><i class="fas fa-edit"></i> Edit</a></td>
                  </tr>
                  @endforeach
                </table>
              </div>
          ...
          <div class="row">
            <div class="col-sm text-left">
              <a href="/superadmin/queues/new" class="btn btn-primary"><i class="fas fa-arrow-alt-circle-left"></i> Back</a>
