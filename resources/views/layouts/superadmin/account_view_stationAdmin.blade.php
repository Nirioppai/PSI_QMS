...
@section('title')
<title>PSI Queue | Station Administrators</title>
@endsection
  ...
  <div class="row justify-content-center align-items-center">
    <div class="card bg-secondary shadow-lg border-0">
      <div class="card-header bg-transparent">
        <h3 class="mb-0">List of Station Administrators</h3>
      </div>
        ...
        <div class="container">
          <div class="table-responsive">
            <table class="table align-items-center table-flush">
              ...
              <tr>
                 <td class="text-left">{{$StationAdmin->name}}</td>
                 <td class="text-left">{{$StationAdmin->username}}</td>
                 <td class="text-left">{{$StationAdmin->created_by}}</td>
              </tr>
              @endforeach
           </table>
          </div>
