...
<div class="modal fade" id="TransferModal" tabindex="-1" role="dialog" aria-labelledby="customNumberModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-secondary modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="customNumberModalLabel">Transferring a number to another Station</h4>
      ...
      <div class="modal-body">
				...
				<div class="container">
				  <div class="row">
				    <div class="col-sm">
				     	<h5 class="card-title text-left">Select a station for the current number to be transferred to.</h5>
