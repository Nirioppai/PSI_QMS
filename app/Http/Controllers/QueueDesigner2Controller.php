...
class QueueDesigner2Controller extends Controller
{
    ...
    public function index()
    {
        ...
        return view('layouts.superadmin.queue_new_modify')->with('queue_designer1s', $QueueDesigner1)->with('QueueName', $QueueName)->with('number_of_stations', $number_of_stations);
    }
    ...
    public function edit($id)
    {
        ...
        return view('layouts.superadmin.queue_new_modify_edit')->with('users', $users)->with('queue_designer1', $queue_designer1);
